...
import { RadiusResultPayload, MunicipioRaio } from './_components/MapLibrePolygons';
import EstrategiaFiltersMenu from './_components/EstrategiaFiltersMenu';
import RelacionamentoModal, { MunicipioDisponivel } from './_components/RelacionamentoModal';
...
const MapLibrePolygons = dynamic(() => import('./_components/MapLibrePolygons'), { ssr: false });
...
export default function EstrategiaPage() {
  ...
  // 🆕 Estados para efeito de confetti e mensagem de celebração
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white">
              ...
              >
                <div className="bg-[#1e293b] border border-slate-700/50 rounded-lg p-3">
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                    ...
                    {/* POLO */}
                    <div className="flex flex-col">
                      <label className="text-slate-300 text-sm mb-0.5 text-center font-bold">POLO LOGÍSTICO</label>
                    ...
                    <div className="flex flex-col">
                      <label className="text-slate-300 text-sm mb-0.5 text-center font-bold">MUNICÍPIOS SATÉLITES</label>
                    ...
                    >
                      <div className="h-[450px]">
                        <MapLibrePolygons
                          ...
                          // 🆕 Passa Set de códigos com relacionamento ativo para destacar em verde
      ...
      <RelacionamentoModal
        ...
        onClose={(novosCadastros) => {
          ...
          // 🎉 Se houve novos cadastros, ativar confetti e mensagem
      ...
      {/* 🎊 Efeito de Confetti para celebração */}
      <ConfettiEffect 
